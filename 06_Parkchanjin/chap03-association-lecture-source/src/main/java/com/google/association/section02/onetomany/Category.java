package com.google.association.section02.onetomany;
...
public class Category {
    ...
    /* @OneToMany
    *  - 일대다 관계를 매핑할 때 사용
    *  - Category 엔티티 하나(1)가 여러 Menu 엔티티(N)를 가질 수 있는 관계
    *
    * [주의점]
    *  - 일대다 단방향 매핑은
    ...
    *
    *    -> 현재 엔티티(Category)의 PK와 반대편 엔티티(Menu)의 FK를 직접 등록 해줘도
    *       불필요한 UPDATE SQL이 수행된다.
    *
    *  - "N + 1 문제"가 발생할 수 있다
    *
    ...
    *   - Category 엔티티 조회 시 Menu 엔티티를 JOIN 하여 같이 조회
    *    -> select가 1회 수행
    * */
