package com.google.jpql.section08.namedquery;
...
public class NamedQueryRepository {
  ...
  public List<Menu> selectByNamedQuery() {
    // 이름으로 미리 정의된 NamedQuery인 Section08Menu.selectMenuList 사용해서 쿼리 객체 생성 후 결과 반환
  ...
  public Menu selectByNamedQueryWithXml(int menuCode) {
    Menu foundMenu
        = manager.createNamedQuery("Section08Menu.selectMenuByCode", Menu.class)
